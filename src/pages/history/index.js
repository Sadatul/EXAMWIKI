...
export default function HistoryPage({ repo }) {
        ...
        examList.push(
            <tr key={i}>
                ...
                <td className="text-center">
                    ...
                    }} target="_blank" className=" text-white text-sm 
                    no-underline p-1 rounded-xl bg-blue-500 hover:bg-blue-950">Go To Report</Link>
                </td>
            </tr>
        );
    }
    ...
    return <div>
        <div className="text-center text-3xl font-bold mt-5">Exam History of {repo.username}</div>
